              ...
              this.documentService.getSelectedDoc(this.sharedocument.fileid).subscribe(data1 => {
               ...
               this.userService.getuserid(this.selectedDoc.uid).subscribe(userdata=>{
                ...
                if (this.sharedocument.accesstype == "Allowusers") {
                  if(this.sharedocument && (this.sharedocument.agreetoSign && !this.sharedocument.view) || (this.sharedocument.agreetoReview && this.sharedocument.view)){
...
var data = { _id: this.sharedocument._id, agreetoReview: agreereview };
