...
if(sharedfolderid) localStorage.removeItem('folder')
  ...
  if(content)
  {
    ...
    this.documentService.encryptedvalues(data).subscribe((data:any)=>{
      console.log(this.documentres.agreetoSign && this.documentres.agreetoReview)
 if ((this.documentres.agreetoSign && !this.documentres.view) || (this.documentres.agreetoReview && this.documentres.view) && data.fileid && data.sharedid) this.router.navigate(['/sharereview/'+data.sharedid+'/'+data.fileid]);
 else if ((this.documentres.agreetoSign && !this.documentres.view) || (this.documentres.agreetoReview && this.documentres.view) && data.fileid && !data.sharedid) this.router.navigate(['/sharereview/'+data.fileid]);
 else if ((!this.documentres.agreetoSign && !this.documentres.view) || (!this.documentres.agreetoReview && this.documentres.view)) document.getElementById('basicExampleModal').click()
})
...
// agree to review update the sharing record 
