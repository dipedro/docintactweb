...
exports.create = function (req, res) {
  console.log("docintact",req.body)
  var userArray = []
  var sharedData = []
...
exports.Sharedpeopleupdate = function (req, res) {
  ...
  if(req.body.updateforAgree)
   ...
   console.log(req.body.title,'Signature')
...
if(userdata.companyname){userdata.name = userdata.companyname
  ...
  if( requestedbody && requestedbody.fileid.name) filename=requestedbody.fileid.name
if(requestedbody && !requestedbody.fileid.name && requestedbody.fileid){
  Document.findById(requestedbody.fileid, function (err, document) {
    ...
    '<div class="m_233836446190015510mailer-layout-background" style="width:100%;padding-bottom:50px;">' +
        ...
        '<td class="m_233836446190015510no-border m_233836446190015510body-content-column" style="border-collapse:collapse;width:inherit!important;margin:10px;border:none;" valign="top">' +
        '<h3><strong></strong></h3><span class="im">&nbsp;<a class="m_233836446190015510btn m_233836446190015510btn-primary"  href="' + config.frontendUrl + "/allowusers/" + sharingdocumentid + '" style="text-decoration:none;display:inline-block;font-weight:normal;line-height:1.25;text-align:center;white-space:nowrap;vertical-align:middle;font-size:1rem;border-radius:0.25rem;color:#fff;background-color:#0275d8;padding:0.5rem 1rem;border:1px solid #0275d8;" target="_blank">View Document</a><div class="m_233836446190015510sent-by-text" style="font-size:14px;margin-top:16px;"><div>Shared by ' + userdata.name + '</div><div class="m_233836446190015510text-muted"><div>Document : ' + document.name + '</div></div></div></span></td>' +
        '</tr>' +
        '</tbody>' +
        '</table>' +
        '</td>' +
  ...
  '<div class="m_233836446190015510mailer-layout-background" style="width:100%;padding-bottom:50px;">' +
      ...
      '<a  href="' + config.frontendUrl + "/allowusers/" + sharingdocumentid + '" style="text-decoration:none;" target="_blank"><img class="m_233836446190015510document-thumbnail-image CToWUd fr-fic fr-dib" src="https://staging.docintact.com/assets/images/document.png" alt="test.pdf" style="outline: none; text-decoration: none; border: none; width: 150px !important; max-width: 150px !important;"></a></td>' +
      '<td class="m_233836446190015510no-border m_233836446190015510body-content-column" style="border-collapse:collapse;width:inherit!important;margin:10px;border:none;" valign="top">' +
      '<h3><strong></strong></h3><span class="im">&nbsp;<a class="m_233836446190015510btn m_233836446190015510btn-primary"  href="' + config.frontendUrl + "/allowusers/" + sharingdocumentid + '" style="text-decoration:none;display:inline-block;font-weight:normal;line-height:1.25;text-align:center;white-space:nowrap;vertical-align:middle;font-size:1rem;border-radius:0.25rem;color:#fff;background-color:#0275d8;padding:0.5rem 1rem;border:1px solid #0275d8;" target="_blank">View Document</a><div class="m_233836446190015510sent-by-text" style="font-size:14px;margin-top:16px;"><div>Shared by ' + userdata.name + '</div><div class="m_233836446190015510text-muted"><div>Document : ' + filename + '</div></div></div></span></td>' +
      '</tr>' +
      '</tbody>' +
      '</table>' +
      '</td>' +
